...
**Registro histórico.** A referência instalada atual está em [ESTADO_DO_PROJETO.md](ESTADO_DO_PROJETO.md). O commit e a CI abaixo descrevem a promoção anterior; não validam a 0.4.10.
...
As correções da promoção de 12/09/2026 e a integração Snapshot/Bundle estão incluídas nessa referência.
