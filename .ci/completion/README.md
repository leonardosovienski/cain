...
The branch root retains the baseline source; cain-overlay.zip contains the candidate
runtime. The workflow reconstructs it and checks all recorded bytes before execution.
